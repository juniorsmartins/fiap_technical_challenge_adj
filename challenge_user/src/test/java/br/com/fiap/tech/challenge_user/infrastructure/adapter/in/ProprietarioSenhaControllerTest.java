...
class ProprietarioSenhaControllerTest {

    @Mock
    private UsuarioSenhaInputPort<ProprietarioEntity> senhaInputPort;

    @InjectMocks
    private ProprietarioSenhaController proprietarioSenhaController;
    ...
    void deveAtualizarSenhaComSucesso() {
        ...
        // Act
        ResponseEntity<Void> response = proprietarioSenhaController.updatePassword(senhaDtoRequest);
    ...
    void deveLancarInternalServerProblemExceptionQuandoSenhaDtoRequestEhNulo() {
        ...
        InternalServerProblemException exception = assertThrows(
                ...
                () -> proprietarioSenhaController.updatePassword(null)
        );
