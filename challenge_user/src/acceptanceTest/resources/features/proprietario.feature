...
Funcionalidade: testar operações Create/POST, Read/GET, Update/PUT e Delete/DELETE
  ...
  Contexto:
    ...
    Dado cadastros de Proprietários disponíveis no banco de dados
      ...
      |    James Clear    |     clear@gmail.com    |    james    |    james12    |   78098-179  |     Rua L    |     300    |        contador         |
  ...
  Cenario: Put para atualizar Proprietario, com erro por nome não único, pelo ProprietarioController
    Dado um identificador ID de um proprietario existente, com email "clear@gmail.com"
    E um ProprietarioDtoRequest, com nome "Martin Fowler" e email "clear@gmail.com" e login "james" e senha "james12" e descricao "contador"
    Quando uma requisição Put for feita no método update do ProprietarioController
    Entao receber ResponseEntity com HTTP 409 do ProprietarioController
    E o Proprietario no database possui nome "James Clear" e email "clear@gmail.com" e login "james" e senha "james12" e descricao "contador"

  Cenario: Put para atualizar Proprietario, com erro por email não único, pelo ProprietarioController
    Dado um identificador ID de um proprietario existente, com email "clear@gmail.com"
    E um ProprietarioDtoRequest, com nome "James Clear" e email "beck2@proton.me" e login "james" e senha "james12" e descricao "contador"
    Quando uma requisição Put for feita no método update do ProprietarioController
    Entao receber ResponseEntity com HTTP 409 do ProprietarioController
    E o Proprietario no database possui nome "James Clear" e email "clear@gmail.com" e login "james" e senha "james12" e descricao "contador"
  ...
  Cenario: Put para atualizar Proprietario, com erro por login não único, pelo ProprietarioController
    Dado um identificador ID de um proprietario existente, com email "clear@gmail.com"
    E um ProprietarioDtoRequest, com nome "James Clear" e email "clear@gmail.com" e login "jsuther" e senha "james12" e descricao "contador"
    Quando uma requisição Put for feita no método update do ProprietarioController
    Entao receber ResponseEntity com HTTP 409 do ProprietarioController
    E o Proprietario no database possui nome "James Clear" e email "clear@gmail.com" e login "james" e senha "james12" e descricao "contador"
  ...
  Cenario: Put para atualizar Proprietario e remover Endereço (cenário 2), com sucesso, pelo ProprietarioController
    Dado um identificador ID de um proprietario existente, com email "clear@gmail.com"
    E um ProprietarioDtoRequest, com nome "James Clear Jr" e email "jclear@email.com" e login "clear" e senha "clear12" e descricao "TI da empresa"
    Quando uma requisição Put for feita no método update do ProprietarioController
    Entao receber ResponseEntity com HTTP 200 do ProprietarioController
    E com ProprietarioDtoResponse no body, com id e nome "James Clear Jr" e email "jclear@email.com" e login "clear" e senha "clear12" e descricao "TI da empresa"
    E sem EnderecoDtoResponse no body pelo ProprietarioController
    E o Proprietario no database possui nome "James Clear Jr" e email "jclear@email.com" e login "clear" e senha "clear12" e descricao "TI da empresa"
  ...
  Cenario: Put para atualizar Proprietario e atualizar Endereço (cenário 4), com sucesso, pelo ProprietarioController
    Dado um identificador ID de um proprietario existente, com email "clear@gmail.com"
    E um ProprietarioDtoRequest e EnderecoDtoRequest, com nome "James Clear Jr" e email "jclear@email.com" e login "clear" e senha "clear12" e descricao "TI da empresa" e com cep "68513-224" e logradouro "Quadra Vinte" e número "25"
    Quando uma requisição Put for feita no método update do ProprietarioController
    Entao receber ResponseEntity com HTTP 200 do ProprietarioController
    E com ProprietarioDtoResponse no body, com id e nome "James Clear Jr" e email "jclear@email.com" e login "clear" e senha "clear12" e descricao "TI da empresa"
