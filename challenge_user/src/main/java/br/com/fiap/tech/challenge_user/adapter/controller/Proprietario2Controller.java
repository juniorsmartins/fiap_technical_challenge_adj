...
public class Proprietario2Controller
        extends AbstractUsuarioController<ProprietarioDtoRequest, ProprietarioDtoResponse, Proprietario, ProprietarioEntity> {

    protected static final String URI_PROPRIETARIO = "/api/v1/challenge-user/proprietarios";

    public Proprietario2Controller(
            AbstractUsuarioMapper<ProprietarioDtoRequest, ProprietarioDtoResponse, Proprietario, ProprietarioEntity> mapper,
