...
@Schema(name = "ProprietarioUpdateDtoRequest", description = "Transportador de dados de entrada em requisições.")
public record ProprietarioUpdateDtoRequest(
        ...
        @Schema(name = "descricao", description = "Espaço livre para anotações.",
                example = "Meio período como atendente na empresa.")
        String descricao
) {
}
